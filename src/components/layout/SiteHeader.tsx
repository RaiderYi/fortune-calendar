...
export default function SiteHeader({ onLoginClick }: SiteHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full lg:ml-56 lg:w-[calc(100%-14rem)] bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-700">
